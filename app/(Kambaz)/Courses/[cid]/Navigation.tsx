...
export default function CourseNavigation() {
  return (
    <div id="wd-courses-navigation">
      ...
      <Link href="https://zoom.com" id="wd-course-zoom-link">Zoom</Link><br/>
      <Link href="/Courses/1234/Assignments" id="wd-course-assignments-link">
          Assignments</Link><br/>
      <Link href="https://northeastern.instructure.com/courses/225999/quizzes" id="wd-course-quizzes-link">Quizzes
        </Link><br/>
